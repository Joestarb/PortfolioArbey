...
const AboutMe = () => {
    return (
        <div id='sobre-mi'  className=' pt-7'>
            <div>
            </div>
            <div className="flex items-center text-3xl justify-center">
                
            <div className=" w-[19%]  sm:w-[40%] border-t-2 border-[#C778DD] ml-4"></div>
            ...
            <div  className=' py-12  sm:mx-9'>
                <p>Hola!</p>
                    ...
                    <br />
                    <p className=' max-sm:hidden'>Además, estoy interesado en explorar nuevas tecnologías y aprendizaje continuo para mantenerme actualizado en un campo tan dinámico y en constante evolución como lo es el desarrollo de software.</p>
